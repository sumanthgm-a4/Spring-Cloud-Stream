package com.sum.spring_cloud_stream.sec14;
...
public class SectionRunner {
	...
	static class PhysicalDeliveryConsumer {
		...
		static void main() {
			SpringApplication.run(PhysicalDeliveryConsumer.class, "--section=sec14", "--config=02-physical-consumer", "--server.port=8081");
		}
	...
	static class Processor {
		...
		static void main() {
			SpringApplication.run(Processor.class, "--section=sec14", "--config=03-processor", "--server.port=8082");
		}
	...
	static class Producer {
		...
		static void main() {
			SpringApplication.run(Producer.class, "--section=sec14", "--config=04-producer", "--server.port=8083");
		}
